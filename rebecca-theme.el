...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(trailing-whitespace ((,class :foreground "unspecified-bg" :background ,warning)))
   ...
   `(helm-grep-match ((,class (:foreground "unspecified-bg" :background "unspecified-bg" :inherit helm-match))))
